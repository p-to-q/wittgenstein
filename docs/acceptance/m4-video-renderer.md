...
Accept the structured video renderer without confusing it with neural text-to-video generation. This acceptance surface should track the already-landed repo-owned renderer work and the cross-platform determinism follow-up rather than re-deriving a separate product story.
...
- PR #456 — repo-owned video MP4 renderer
- Issue #359 — cross-platform structural parity and receipt portability
