...
| `titok`                               | **not registered**. 1D tokenizer checkpoints are available, but upstream marks models research-only; RFC-0007 did not activate.        | #332                             | [`2026-05-31-titok-gate-b-license-closeout.md`](../../../../docs/research/2026-05-31-titok-gate-b-license-closeout.md)                                                                                          |
